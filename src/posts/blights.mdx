...
![a block of aluminum with three gigantic COB LEDs glued to the top of it](/blights/images/array-photo.jpg)  
...
<br>
<div class="image-container" style="display: flex; height: 35ch;"> <img src="/blights/images/jankatron-watercooling.jpg" alt="todo" style="width: 100%; height: auto; object-fit: contain;"> <img src="/blights/images/psu-pic.jpg" alt="todo" style="width: 100%; height: auto; object-fit: contain;"> </div> 
...
![an uncovered plastic bucket filled with water sitting inside a cabinet. there are two latex tubes running from a hole in the top of the cabinet into the bucket, as well as a temperature probe](/blights/images/early-installation-reservoir.jpg)
![the top of a cabinet. there's a boost converter wired to an aquarium pump that's sitting in a planter and a couple of giant LEDs mounted to a water cooling block, as well as a benchtop power supply to the far right](/blights/images/early-installation-top.jpg)
...
```
and set up a cronjob to run it when my alarm went off. Yeah, a bit hacky&mdash;a 
better idea might be to set up NTP on-device and implement the timer/'sunrise' there&mdash;but 
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/mDUrG0VyKGY?si=cHbeHPtEOaJYcCJy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
