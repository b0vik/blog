...
(the esp32-c3 and iirc all of espressif's socs also have a hardware pwm controller with a [fairly nice api](https://docs.espressif.com/projects/esp-idf/en/v5.2/esp32c3/api-reference/Arduinoperipherals/ledc.html) somewhat tailored to this purpose) 
